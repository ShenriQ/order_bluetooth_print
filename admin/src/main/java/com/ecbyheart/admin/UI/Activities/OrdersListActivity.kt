...
class OrdersListActivity : BaseActivity() {
    ...
    lateinit var orderType: Spinner
    ...
    override fun initializeComponents() {
        ...
        orderType.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
    ...
    fun setData(lastCount: Int = 0, status: Int) {
        AdminOrderService.removeNewOrdersListener()
        AdminOrderService.removeInprogressOrdersListener()
        when (status) {
...
//                showLoader()
//                AdminOrderService.getInprogressOrders(object :
...
//            }
            1 -> {
                showLoader()
                AdminOrderService.getCompletedOrders(lastCount,
