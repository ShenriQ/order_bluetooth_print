...
//                Glide.with(image.context).load(order.bookings.first().booking_service!!.image).transform(
//                    CenterCrop(),
//                    RoundedCorners(25)
//                ).apply(RequestOptions().placeholder(R.drawable.placeholder).error(R.drawable.placeholder)).into(image)
//            }
//            else {
//                var product_image = ""
//                if(order.products.first().product!!.photos != null && order.products.first().product!!.photos!!.size > 0) {
//                    product_image = order.products.first().product!!.photos!!.first()
//                }
//                Glide.with(image.context).load(product_image).transform(
//                    CenterCrop(),
//                    RoundedCorners(25)
//                ).apply(RequestOptions().placeholder(R.drawable.placeholder).error(R.drawable.placeholder)).into(image)
//            }
